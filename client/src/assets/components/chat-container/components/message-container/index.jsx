        ...
        message.messageType === 'file' && <div
          ...
          {checkIfImage(message.fileUrl) ?
            (<div className='cursor-pointer' onClick={() => { setShowImage(true); setImageUrl(message.fileUrl) }}>
              <img src={`${HOST}/${message.fileUrl}`} height={300} width={300} alt="img" />
            </div>
            ) :
            (
        ...
        }
        {
          message.sender._id !== userInfo.id ? (
            <div className='flex items-center justify-start gap-3'>
              <Avatar className='h-8 w-8 border-[1px] rounded-full overflow-hidden'>
                ...
                <AvatarFallback className={`uppercase h-8 w-8 text-lg flex items-center justify-center ${getColor(message.sender.color)}`}>
